...
function [Q_tot Q_ind_e_vec Q_ind_h_vec y_e_vec y_h_vec v_e_vec v_h_vec E_q_y_e_vec E_q_y_h_vec E_w_y_e_vec E_w_y_h_vec Phi_w_y_e_vec Phi_w_y_h_vec] = getSignalPlanarSensor(xtrack,Qin,D,S,N0,isNtype,isOxygenated,Vbias,fluence,T, t,dt, N)
    % constants
    ...
    tr_e = getTrappingTimeSecond(fluence,1); %trapping time of electrons [ns]
    tr_h = getTrappingTimeSecond(fluence,0); %trapping time of holes [ns]
