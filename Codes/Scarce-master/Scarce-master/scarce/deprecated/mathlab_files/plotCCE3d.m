...
% 	Q_tot_2 = getSignal3dSensor(xtrack,ytrack,Qin,D,S,R,N0,isNtype,isOxygenated,Vbias_2,ifluence,T, t,dt);
	CCE_1(iter)=abs(min(mean(Q_ind_e_vec(:,:)+Q_ind_h_vec(:,:),1)))./Qin.*100;
...
% hold off;
title_str = sprintf('Charge collection efficiency of a 3d 200 um pixel detector, %1.0f um electrode distance, %1.0f um radius, charge at (x,y) = (%1.0f,%1.0f) um', S, R, xtrack, ytrack);
