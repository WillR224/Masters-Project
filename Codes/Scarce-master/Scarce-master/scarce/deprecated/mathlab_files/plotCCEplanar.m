...
plot(fluence./1e3, CCE_1, 'COLOR', 'blue','LineWidth', 1.2, 'LineStyle', '-');
hold on;
% plot(fluence, CCE_2, 'COLOR', 'red','LineWidth', 1.2, 'LineStyle', '-');
% hold off;
title('Charge collection efficiency of a planar 300 um pixel detector with 100 um pixel', 'FontWeight','bold','FontSize', 10);
