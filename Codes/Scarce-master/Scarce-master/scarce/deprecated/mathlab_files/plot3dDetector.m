function plot3dDetector(D, S, C, yOff, R, N, x_e, y_e, x_h, y_h, time)
% The parameters are:
...
%plot results
    ...
    xlabel('sensor x');
    ylabel('sensor y'); 
    title_str = sprintf('3d pixel sensor with weighting potential, weighting field direction and charge, %1.2f ns', time);
